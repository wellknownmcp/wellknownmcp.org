  ...
  return (
    <section className="max-w-5xl mx-auto py-12">
      ...
      <p className="text-sm text-muted-foreground text-center max-w-xl mx-auto mb-8">
        These tools extend MCP with actionable formats: prompts, session traces,
        export capsules... All compatible with signature and certification.
      </p>
      ...
      <div className="mt-10 text-sm text-muted-foreground text-center max-w-2xl mx-auto">
        <p>
          The spec is <strong>LLM-ready</strong>. Any smart agent knowing “Kung
          Fu” can already generate valid <code>.llmfeed.json</code> feeds —
          straight from this site.
        </p>
        <p className="mt-2">
          Explore feeds in the{' '}
          <Link href="/llmfeedhub" className="text-purple-700 hover:underline">
            LLMFeedHub
          </Link>
          , share yours in the{' '}
          <Link href="/feeds" className="text-purple-700 hover:underline">
          ...
          >
            agent-readable badges
          </Link>
          , and be part of the{' '}
          <Link href="/ecosystem" className="text-purple-700 hover:underline">
