...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Model Context Protocol evolved into LLMFeed — The open standard for AI-readable websites.',
  ...
  twitter: {
    ...
    creator: '@llmca_org',
    title: 'WellKnownMCP - Open Standard for AI-Readable Websites',
    description: 'Model Context Protocol evolved into LLMFeed — Make your site discoverable by AI agents.',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="agent-entry-point" content="/.well-known/mcp.llmfeed.json" />
        ...
        <meta name="site-mission" content="Open standard for AI-readable websites" />
        <meta name="ecosystem" content="wellknownmcp.org, llmca.org, llmfeedforge.org" />
        ...
        <meta name="target-audience" content="developers,ai-engineers,business-leaders" />
        ...
        <link rel="related" href="https://llmca.org" title="LLMCA Certification Authority" />
        <link rel="related" href="https://llmfeedforge.org" title="LLMFeedForge Tools" />
        ...
        <link rel="alternate" type="application/rss+xml" title="News FR" href="/news/fr/rss.xml" />
        <link rel="alternate" type="application/rss+xml" title="News ES" href="/news/es/rss.xml" />
        <link rel="alternate" type="application/rss+xml" title="News ZH" href="/news/zh/rss.xml" />
        <link rel="alternate" type="application/rss+xml" title="News AR" href="/news/ar/rss.xml" />
        <link rel="alternate" type="application/rss+xml" title="News UK" href="/news/uk/rss.xml" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://wellknownmcp.org',
              description: 'The open standard for AI-readable websites and agent interoperability',
              ...
              about: {
                ...
                description: 'Open standard for structured agent-web interactions',
              },
              potentialAction: [
                {
                  '@type': 'SearchAction',
                  target: 'https://wellknownmcp.org/search?q={search_term_string}',
              ...
              'mcp:version': '2.0',
              'mcp:ecosystem': ['wellknownmcp.org', 'llmca.org', 'llmfeedforge.org'],
        ...
        {/* ✅ NOUVEAU : Preconnect pour performance */}
        <link rel="preconnect" href="https://llmca.org" />
        <link rel="preconnect" href="https://llmfeedforge.org" />
        
        {/* ✅ NOUVEAU : DNS prefetch pour agents */}
        <link rel="dns-prefetch" href="//api.openai.com" />
        <link rel="dns-prefetch" href="//claude.ai" />
        
        {/* ✅ NOUVEAU : Security headers */}
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' fonts.googleapis.com; font-src fonts.gstatic.com" />
